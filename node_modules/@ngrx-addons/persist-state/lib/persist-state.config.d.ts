...
export interface StateMigration<TOldState = any, TNewState = any, TVersionKey = string> {
    /**
...
export interface PersistStateConfig<S> {
     ...
     */
    migrations?: StateMigration<any, any, keyof S>[] | Readonly<StateMigration<any, any, keyof S>[]>;
    /**
...
export interface PersistStateRoot<T, K extends keyof T, S = T[K] extends AnyFunction ? State<T[K]> : never> extends PersistStateConfig<S> {
    /**
...
export declare abstract class PersistStateRootConfig<T extends ActionReducerMap<any, V>, V extends Action = Action> {
    /**
     * The list of states to persist.
     */
    abstract readonly states?: PersistStateRootTyped<T>[];
    /**
     * The storage key prefix.
     */
    abstract readonly storageKeyPrefix?: string;
    /**
     * The strategy used on application startup to rehydrate the state.
     *
     * @default BeforeAppInit
     */
    abstract readonly strategy?: typeof InitializationStrategy;
}
export declare abstract class PersistStateFeatureConfig<T> {
    /**
     * The list of states to persist.
     */
    abstract readonly states: PersistStateConfig<T>[];
    /**
 ...
 */
export declare const PersistStateStrategy: InjectionToken<InitializationStrategy>;
/**
 * Injection token for the list of states to persist.
 */
export declare const PERSIST_STATE_FEATURE_CONFIGS: InjectionToken<PersistStateFeatureConfig<unknown>[]>;
export declare const ROOT_PERSIST_STORE: InjectionToken<string>;
export declare const FEATURE_PERSIST_STATE: InjectionToken<string>;
export {};
