...
var IncrementalSource$1 = ((IncrementalSource2) => {
  ...
  win2.CSSStyleDeclaration.prototype.setProperty = new Proxy(setProperty, {
    apply: callbackWrapper((target, thisArg, argumentsList) => {
      ...
      const {
        id,
        styleId
      } = getIdAndStyleId((_a = thisArg.parentRule) === null || _a === void 0 ? void 0 : _a.parentStyleSheet, mirror2, stylesheetManager.styleMirror);
      if (id && id !== -1 || styleId && styleId !== -1) {
        styleDeclarationCb({
          id,
          styleId,
...
function initCustomElementObserver({
  ...
  const win2 = doc.defaultView;
  if (!win2 || !win2.customElements) return () => {
  };
...
var saveWebGLVar = (value, win2, ctx) => {
  if (!value || !(isInstanceOfWebGLObject(value, win2) || typeof value === "object")) return;
...
function serializeArg(value, win2, ctx) {
  if (value instanceof Array) {
    ...
    return {
      rr_type: name,
      args: [serializeArg(value.buffer, win2, ctx), value.byteOffset, value.byteLength]
    };
...
var ACTIVE_SOURCES = /* @__PURE__ */ new Set([IncrementalSource.MouseMove, IncrementalSource.MouseInteraction, IncrementalSource.Scroll, IncrementalSource.ViewportResize, IncrementalSource.Input, IncrementalSource.TouchMove, IncrementalSource.MediaInteraction, IncrementalSource.Drag, IncrementalSource.Selection]);
